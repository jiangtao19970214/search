...
<div class="content" id="content1">
    ...
    <div class="login-content">
        ...
        <form action="/updata_user" method="post">
        <div class="insert" style="display: none" id="insert">
            <div class="login-box">
                <h1>Insert User Message</h1>
