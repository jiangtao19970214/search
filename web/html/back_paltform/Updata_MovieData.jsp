...
<div class="content" id="content1">
    ...
    <div class="login-content">
        ...
        <form action="/updata_movie" method="post">
        <div class="insert" style="display: none" id="insert">
            <div class="login-box">
                <h1>Insert Movie Message</h1>
                <input type="text" placeholder="Movie_name" name="1">
                <input type="text" placeholder="Movie_author" name="2">
                <input type="text" placeholder="Movie_link" name="3">
                <input type="text" placeholder="Movie_introduction" name="4">
                <input type="text" placeholder="Movie_picture" name="5">
                <button class="login-btn" name="button" value="insert">Go</button>
            </div>
        </div>
        <div class="Delete" style="display: none" id="delete">
            <div class="login-box">
                <h1>Delete Movie Message</h1>
                <input type="text" placeholder="删除的电影名字" name="moviename">
